...
<nav id="sidebar">
    ...
    <div class="sidebar_blog_2">
        ...
        <ul class="list-unstyled components">
            ...
            <li class=""><a href="projects-leads.php"><i class="fa fa-files-o yellow_color"></i> <span>Projects Leads</span></a></li>
            <li class=""><a href="other-leads.php"><i class="fa fa-files-o yellow_color"></i> <span>Other Leads</span></a></li>
            <li class=""><a href="career.php"><i class="fa fa-files-o yellow_color"></i> <span>Career</span></a></li>
        </ul>
    </div>
</nav>
<!-- end sidebar -->
