...
<body>
    ...
    <style>
        ...
        .section-support .contact-card .card-title {
            font-family: "Lato", sans-serif !important;
            font-weight: 700 !important;
        ...
        .section-support .contact-card .inner > .fa {
            color: #e57a35 !important;
        }

        .section-support .contact-card .card-detail .list-inline li a {
    ...
    <script>
        // Hamburger side menu + OUR PROJECTS dropdown – same as home/blog pages
        (function () {
