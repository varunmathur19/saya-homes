...
<head>
    ...
    <link rel="stylesheet" href="<?= $base_url ?>/css/new_blogonepage.css">
...
<body class="new-blog-page new-blog-one-page">
    ...
    <section class="blog-banner-section">
        ...
        <div class="blog-banner-content">
            ...
            <nav class="blog-banner-breadcrumb" aria-label="Breadcrumb">
                <a href="<?= $base_url ?>/" class="blog-breadcrumb-link">Homepage</a>
                ...
                <div class="blog-grid">
                    <article class="blog-card">
                        <div class="blog-card-image-link">
                            <img src="<?= $base_url ?>/images/new_theme/ocimageonebblog.jpg" alt="OC Occupancy Certificate" class="blog-card-img">
                        </div>
                        <div class="blog-card-body">
                            <h2 class="blog-card-title">How Will 2026 Homes Be Different From Today's Living Spaces?</h2>
                            <p class="blog-card-meta">By admin, <time class="blog-card-date" datetime="2026-01-06">October 18, 2019</time></p>
                            <div class="blog-card-separator" aria-hidden="true"></div>
                            <p class="blog-card-excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex...</p>
                            <a href="#" class="blog-card-readmore">Read more <img src="<?= $base_url ?>/images/svg/leftarrowabout.svg" alt="" class="blog-readmore-arrow" aria-hidden="true"></a>
                        </div>
                    </article>
                    <article class="blog-card">
                        <div class="blog-card-image-link">
                            <img src="<?= $base_url ?>/images/new_theme/ocimageonebblog.jpg" alt="Blog" class="blog-card-img">
                        </div>
                        <div class="blog-card-body">
                            <h2 class="blog-card-title">Why Is Ghaziabad Becoming the Ultimate Hub for Luxury Living?</h2>
                            <p class="blog-card-meta">By admin, <time class="blog-card-date" datetime="2025-12-15">Dec 15, 2025</time></p>
                            <div class="blog-card-separator" aria-hidden="true"></div>
                            <p class="blog-card-excerpt">Discover why homebuyers are choosing Ghaziabad for premium residential projects and modern amenities.</p>
                            <a href="#" class="blog-card-readmore">Read more <img src="<?= $base_url ?>/images/svg/leftarrowabout.svg" alt="" class="blog-readmore-arrow" aria-hidden="true"></a>
                        </div>
                    </article>
                </div>
                    ...
                    <ul class="blog-recent-list">
                        <li class="blog-recent-item">
                            ...
                            <div class="blog-recent-info">
                                <span class="blog-recent-title">Why Is Ghaziabad Becoming the Ultimate Hub for Luxur...</span>
                        ...
                        <li class="blog-recent-item">
                            <span class="blog-recent-thumb"><img src="<?= $base_url ?>/images/new_theme/homeblog.jpg" alt=""></span>
                            <div class="blog-recent-info">
                                <span class="blog-recent-title">How Will 2026 Homes Be Different From Today's Living...</span>
                        ...
                        <li class="blog-recent-item">
                            <span class="blog-recent-thumb"><img src="<?= $base_url ?>/images/new_theme/homeblog.jpg" alt=""></span>
                            <div class="blog-recent-info">
                                <span class="blog-recent-title">Understanding Occupancy Certificate: A Homebuyer's...</span>
    ...
    <!-- FAQs Section (template: dark grey, accordion only) -->
    <section class="faqs-section faqs-section-template">
            ...
            <div class="faqs-accordion">
                <div class="faqs-accordion-item">
                    <button type="button" class="faqs-accordion-head" aria-expanded="false" aria-controls="faq-1" id="faq-head-1">
                        ...
                        <span class="faqs-accordion-q">What is the property rate in greater Noida?</span>
                        <span class="faqs-accordion-icon">+</span>
                    </button>
                    <div class="faqs-accordion-body" id="faq-1" hidden>
                        <p class="faqs-accordion-answer">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    </div>
                </div>
                ...
                <div class="faqs-accordion-item">
                    ...
                    <div class="faqs-accordion-body" id="faq-3" hidden>
                        <p class="faqs-accordion-answer">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    </div>
                </div>
                <div class="faqs-accordion-item">
                    ...
                    <div class="faqs-accordion-body" id="faq-4" hidden>
                        <p class="faqs-accordion-answer">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    </div>
                </div>
            </div>
    ...
    (function() {
        ...
        if (!section) return;
        section.querySelectorAll('.faqs-accordion-head').forEach(function(btn) {
            btn.addEventListener('click', function() {
                var item = this.closest('.faqs-accordion-item');
                var body = this.nextElementSibling;
                var isOpen = item.classList.contains('is-open');
                section.querySelectorAll('.faqs-accordion-item').forEach(function(i) {
                    i.classList.remove('is-open');
                    var b = i.querySelector('.faqs-accordion-body');
                    if (b) b.setAttribute('hidden', '');
                    var h = i.querySelector('.faqs-accordion-head');
                    if (h) h.setAttribute('aria-expanded', 'false');
                    var icon = i.querySelector('.faqs-accordion-icon');
                ...
                if (!isOpen) {
                    ...
                    var icon = this.querySelector('.faqs-accordion-icon');
                    if (icon) icon.textContent = '−';
                }
            });
        });
