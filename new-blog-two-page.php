                ...
                <div class="blog-grid">
                    <article class="blog-card">
                        ...
                        <div class="blog-card-body">
                            ...
                            <p class="blog-card-excerpt">There Are Just A Few Weeks Left Before We Step Into 2026, And You Might Have Already Noticed How Our Li...</p>
                    ...
                    <article class="blog-card">
                        ...
                        <div class="blog-card-body">
                            ...
                            <h2 class="blog-card-title">Understanding Occupancy Certificate: A Homebuyer's Guide</h2>
                            <p class="blog-card-excerpt">Everything you need to know about OC and why it matters for your new home in NCR.</p>
                            <span class="blog-card-readmore">Read More <img src="<?= $base_url ?>/images/new_theme/readmorearrow.svg" alt="" class="blog-readmore-arrow" aria-hidden="true"></span>
                        </div>
                    </article>
                    <article class="blog-card">
                        ...
                        <div class="blog-card-body">
                            ...
                            <h2 class="blog-card-title">Saya Homes Projects That Redefine Greater Noida West</h2>
                            <p class="blog-card-excerpt">Explore our flagship residential and commercial developments in one of NCR's fastest-growing corridors.</p>
                            <span class="blog-card-readmore">Read More <img src="<?= $base_url ?>/images/new_theme/readmorearrow.svg" alt="" class="blog-readmore-arrow" aria-hidden="true"></span>
                        </div>
                    </article>
                </div>
