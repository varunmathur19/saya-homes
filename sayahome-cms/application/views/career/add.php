    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <?php echo form_open_multipart(base_url('career/add'), 'class="form-horizontal"');  ?> 
              ...
              <div class="col-md-12">
                  <input type="text" name="experience" value="<?php echo set_value('experience') ?>" class="form-control" id="experience" placeholder="Experience">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <textarea name="description" id="editor1" class="form-control editor1" placeholder="Description"><? echo set_value('description') ?></textarea>
                </div>
              </div>
