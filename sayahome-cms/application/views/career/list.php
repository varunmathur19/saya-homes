                ...
                <main>
                    ...
                    <div class="container-fluid px-4">
                        <br><br>
                         ...
                         <div class="card mb-4">
                            <div class="add-btn">
                                <a href="<?php echo base_url()?>career/add" class="btn btn-success">
                                        <span class="glyphicon glyphicon-plus-sign"></span> Add Career Opportunity
                                </a>
                            </div>
...
<script type="text/javascript" language="javascript" >
 ...
 $(document).ready(function(){  
      var dataTable = $('#na_datatable').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url() . 'career/fetch_career'; ?>",  
                type:"POST"  
           }
      });  
 });  
