    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <?php echo form_open_multipart(base_url('coverage/add'), 'class="form-horizontal"');  ?> 
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" name="description" value="<?php echo set_value('description') ?>" class="form-control" id="description" placeholder="Link">
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" name="date" autocomplete="off" class="form-control datepicker" id="date" placeholder="Date">
                </div>
              </div>
