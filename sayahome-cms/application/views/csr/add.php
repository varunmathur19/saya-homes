    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <?php echo form_open_multipart(base_url('csr/add'), 'class="form-horizontal"');  ?> 
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <textarea name="description" class="form-control" id="description" placeholder="Description"><? echo set_value('description') ?></textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" name="year" value="<? echo set_value('year') ?>" class="form-control" id="date" placeholder="Year">
                </div>
              </div>
